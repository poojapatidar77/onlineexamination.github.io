...
import java.sql.*;
import javax.swing.*;
class AdminUserDetails2 extends JPanel
{
		String user;
...
void show(String user)
{
 this.user=user;
	...
	Class.forName("com.mysql.cj.jdbc.Driver");
		...
		String q="select * from students where user_name='"+user+"'";
		...
		ResultSet rs=st.executeQuery(q);
			...
			tx3.setText(rs.getString(3));
			 ...
			 tx8.setText(rs.getString(12));
			 tx9.setText(rs.getString(13));
			
			 Lb13=new JLabel(""+rs.getString(7).toLowerCase());
			 f1=new Font("",Font.BOLD,25);

			 Lb13.setFont(f1);
		     Lb13.setBounds(390,330,150,40);
			 add(Lb13);
		 
	         Lb14=new JLabel(""+rs.getString(9)+"/"+rs.getString(10)+"/"+rs.getString(11));
			 f1=new Font("",Font.BOLD,25);
			 Lb14.setFont(f1);
		     Lb14.setBounds(390,460,250,40);
			 add( Lb14);

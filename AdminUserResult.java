...
import java.util.*;
import javax.swing.*;
class AdminUserResult extends JPanel
{
	Font f1;
	ImageIcon img1,img2;
	JButton b2;
...
void show(String user_name)
{
	try
		...
		String q="select * from studentresult where st_name='"+user_name+"'";
		ResultSet rs=st.executeQuery(q);
    Lb2.setText("Username: "+user_name);
	int k=0;   
   int x=35,y=170;	
	while(rs.next())
	  {
